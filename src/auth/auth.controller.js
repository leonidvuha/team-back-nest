...
var roles_decorator_1 = require("../../../../../../../src/common/decorator/roles.decorator");
var roles_guard_1 = require("../../../../../../../src/common/guards/roles.guard");
var auth_mapper_1 = require("./auth.mapper");
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
        function AuthController_1(service) {
        ...
        AuthController_1.prototype.me = function (user) {
            return (0, auth_mapper_1.toProfileResponseDto)(user);
        };
        AuthController_1.prototype.adminOnly = function (user) {
            return user;
        };
    ...
    (function () {
        ...
        _me_decorators = [(0, common_1.Get)('/me'), (0, common_1.UseGuards)(jwt_guard_1.JwtAuthGuard)];
        _adminOnly_decorators = [(0, common_1.Get)('/admin'), (0, common_1.UseGuards)(jwt_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard), (0, roles_decorator_1.Roles)('ADMIN')];
